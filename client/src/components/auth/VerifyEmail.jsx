...
import { FaSpinner, FaEnvelope, FaCheck, FaShieldAlt, FaRedo } from 'react-icons/fa';
...
const VerifyEmail = () => {
 ...
 const onSubmit = async (e) => {
     ...
     try {
       const result = await dispatch(confirmEmail(token)); 
  ...
  const handleResendCode = async () => {
    ...
    if (results?.success){
        toast.success("Another Verification code has been sent to your email")
