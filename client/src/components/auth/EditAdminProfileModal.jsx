...
import { Camera, Upload, User, Phone, CreditCard, Building2, Briefcase, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-background rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            <h2 className="text-2xl font-bold text-foreground">Edit Admin Profile</h2>
                ...
                <div className="relative group hover:scale-105 transition">
                  <div className="w-32 h-32 rounded-full border-4 border-primary/30 bg-muted overflow-hidden flex items-center justify-center shadow-inner">
                    {photoPreview ? (
                      ...
                      <img
                        src={`https://ui-avatars.com/api/?name=${encodeURIComponent(form.watch('fullName') || profile?.fullName || 'Admin')}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex items-center gap-2 text-foreground">
                        <Briefcase className="h-4 w-4 text-primary" /> Position *
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex items-center gap-2 text-foreground">
                        <CreditCard className="h-4 w-4 text-primary" /> Status
                      </FormLabel>
                      <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl>
                          <SelectTrigger className="h-11">
